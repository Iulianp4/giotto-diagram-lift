...
public final class AModeConnectionAnnotation extends PModeConnectionAnnotation
{
    ...
    public AModeConnectionAnnotation()
    {
    }
    ...
    public Object clone()
    {
        return new AModeConnectionAnnotation(
    ...
    {
        ((Analysis) sw).caseAModeConnectionAnnotation(this);
    }
